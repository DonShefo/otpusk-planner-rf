...
2. Распакуйте папку целиком и запустите `grafik_otpuskov.exe` (файл `WebView2Loader.dll` должен лежать рядом).
...
> ℹ️ Портативный EXE — это сборка более ранней версии приложения: основная функциональность та же, но новейших доработок HTML-версии в нём может не быть. Рекомендуемый и всегда актуальный вариант — HTML/демо выше.
